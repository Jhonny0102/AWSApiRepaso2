...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddDbContext<SeriesContext>(options => options.UseMySql(connectionString, ServerVersion.AutoDetect(connectionString)));
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        {
            options.SwaggerEndpoint(url: "swagger/v1/swagger.json", "ApiSerieAWSRepaso");
            options.RoutePrefix = "";
        });
        //
